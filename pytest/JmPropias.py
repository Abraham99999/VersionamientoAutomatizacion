...
class btest(unittest.TestCase):
    ...
    def test1_transferencia(self):
        ...
        for i in range(len(montos)):
            ...
            selCuenta = wait.until(EC.presence_of_element_located((By.XPATH, "//button[@class='mifel-simplified-table__row container position-relative text-start mifel-simplified-table__row--shadow']")))
